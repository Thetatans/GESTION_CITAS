...
<body>
    ...
    <div class="container mt-4">
        <h1><i class="bi bi-plus-circle"></i> <?= esc($titulo) ?></h1>
        <hr>
        ...
        <div class="card shadow">
            <div class="card-body">
                <form action="<?= base_url('admin/servicios/guardar') ?>" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="duracion_minutos" class="form-select" required>
                                ...
                                <option value="20" <?= old('duracion_minutos') == '20' ? 'selected' : '' ?>>20 min</option>
                                <option value="40" <?= old('duracion_minutos', '40') == '40' ? 'selected' : '' ?>>40 min</option>
                                <option value="60" <?= old('duracion_minutos') == '60' ? 'selected' : '' ?>>60 min (1 hora)</option>
                                <option value="80" <?= old('duracion_minutos') == '80' ? 'selected' : '' ?>>80 min</option>
                                <option value="100" <?= old('duracion_minutos') == '100' ? 'selected' : '' ?>>100 min</option>
                                <option value="120" <?= old('duracion_minutos') == '120' ? 'selected' : '' ?>>120 min (2 horas)</option>
                                <option value="140" <?= old('duracion_minutos') == '140' ? 'selected' : '' ?>>140 min</option>
                                <option value="160" <?= old('duracion_minutos') == '160' ? 'selected' : '' ?>>160 min</option>
                                <option value="180" <?= old('duracion_minutos') == '180' ? 'selected' : '' ?>>180 min (3 horas)</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="text-end">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Guardar Servicio</button>
                    </div>
                </form>
            </div>
        </div>
