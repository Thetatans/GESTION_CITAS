...
<body>
    ...
    <div class="container mt-4">
        <h1><i class="bi bi-person-plus-fill"></i> <?= esc($titulo) ?></h1>
        <hr>
        ...
        <div class="card shadow">
            <div class="card-body">
                <form action="<?= base_url('admin/empleados/guardar') ?>" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="especialidad" class="form-control" value="<?= old('especialidad') ?>" placeholder="Ej: Barbero, Estilista...">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Comisión (%)</label>
                            <input type="number" step="0.01" min="0" max="100" name="comision_porcentaje" class="form-control" value="<?= old('comision_porcentaje', '0') ?>">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="fecha_contratacion" class="form-control" value="<?= old('fecha_contratacion', date('Y-m-d')) ?>">
                        </div>
                    </div>
